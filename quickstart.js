/* SPLITSTEEL · quickstart.js
   Replays the wizard's real screens, and fills in the cards on the table as
   the screens ask for it. demo.js is generated by tools/make-demo.py from
   blender/wizard.py: every frame here was drawn by the program itself, and
   every card state was worked out from the values that sitting really used.
